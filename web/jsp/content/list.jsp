...
<div class="container">
    <div class="row">
        ...
        <%
            ...
            List<Content> contents = (List) request.getAttribute("contents");
            int state;
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a href="${pageContext.request.contextPath}/edit?vote=<%=content.getId()%>"><strong class="text-success"><%= content.getTitle()%></strong></a>
                        <a class="btn pull-right" href="${pageContext.request.contextPath}/delete?vote=<%=content.getId()%>">删除 »</a>
                    </h3>
                </div>
                ...
                <div class="panel-footer">
                    <a class="btn" href="${pageContext.request.contextPath}/edit?vote=<%=content.getId()%>">进入编辑 »</a>
